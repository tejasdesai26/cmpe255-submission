...
polym.fit(x_poly,y_train)

#print(polym.intercept_)
#print(polym.coef_)

#Calculate root mean square error
mse = mean_squared_error(y_test, polym.predict(polyf.fit_transform(x_test)))
print("Root mean square error: ",np.sqrt(mse))

#r2_score value
#print("R Square Coefficient (R-squared score)", polym.score(x_test, y_test))

# Calculate r2_score another way
pred_y = polym.predict(polyf.fit_transform(x_test))
